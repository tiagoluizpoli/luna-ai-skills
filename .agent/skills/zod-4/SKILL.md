---
name: zod-4
description: Deep-dive specialist for Zod v4. Enforces strict schema validation, type-safe parsing, and v3 -> v4 migration patterns. Must be engaged for ANY task involving request validation, form schemas, or API payload hardening.
source: https://github.com/prowler-cloud/prowler/tree/master/skills/zod-4
---
