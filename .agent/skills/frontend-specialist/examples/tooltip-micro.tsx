...
const arrowStyles = {
  ...
  bottom:
    'bottom-full left-1/2 -translate-x-1/2 border-b-zinc-900 border-x-transparent border-t-transparent',
  left: 'left-full top-1/2 -translate-y-1/2 border-l-zinc-900 border-y-transparent border-r-transparent',
  right:
    'right-full top-1/2 -translate-y-1/2 border-r-zinc-900 border-y-transparent border-l-transparent',
} as const;
        ...
        <AnimatePresence>
          {isVisible && (
            <motion.div
              ...
              className={cn(
                'pointer-events-none absolute z-[600] whitespace-nowrap',
            ...
            >
              {content}
              {/* Arrow */}
              <span className={cn('absolute border-4', arrowStyles[side])} />
            </motion.div>
          )}
        </AnimatePresence>
      </div>
