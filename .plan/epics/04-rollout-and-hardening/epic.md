...
| --- | --- | --- | --- | --- |
| T-10 | Apply the framework to a real consumer repository | done | — | `.plan/epics/04-rollout-and-hardening/tasks/01-consumer-repo-rollout.md` |
| T-11 | Harden helper scripts into richer automation | done | — | `.plan/epics/04-rollout-and-hardening/tasks/02-helper-script-hardening.md` |
| T-12 | Wire the full runner state machine to the new contract | done | — | `.plan/epics/04-rollout-and-hardening/tasks/03-runner-state-machine.md` |
