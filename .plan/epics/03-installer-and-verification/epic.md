...
| T-09 | Validate the public GitHub bootstrap path | blocked | remote-repo-not-public | `.plan/epics/03-installer-and-verification/tasks/03-public-bootstrap-validation.md` |
