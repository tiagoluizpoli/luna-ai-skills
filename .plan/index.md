...
| T-17 | E-06 | Asset routing contract: shared vs agent-specific assets | in-progress | T-16 | `.plan/epics/06-asset-and-ownership-contract/tasks/01-asset-routing-contract.md` |
