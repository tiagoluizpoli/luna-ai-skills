...
- Add grilling-session summaries here and link to `.plan/grilling/*`.
...
| --- | --- | --- | --- | --- |
| E-01 | Replace Me | ready | — | `.plan/epics/01-replace-me/epic.md` |

## Tasks

| Task ID | Epic ID | Task | Status | Blocked By | File |
| --- | --- | --- | --- | --- | --- |
| T-01 | E-01 | Replace me | ready | — | `.plan/epics/01-replace-me/tasks/01-replace-me.md` |
